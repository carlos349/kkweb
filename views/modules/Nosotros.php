...
<section class="hero-wrap hero-wrap-2" style="background-image: url('views/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
                ...
                <div class="testimony-wrap p-4 pb-5">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(views/images/person_1.jpg)">
		                  </div>
		                  <div class="ml-4">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(views/images/person_2.jpg)">
		                  </div>
		                  <div class="ml-4">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(views/images/person_3.jpg)">
		                  </div>
		                  <div class="ml-4">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(views/images/person_4.jpg)">
		                  </div>
		                  <div class="ml-4">
    ...
    <section class="ftco-counter img" id="section-counter" style="background-image: url(views/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
    		...
    		<div class="row">
					<div class="col-md-3 ftco-animate">
						<a href="views/images/gallery-1.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(views/images/gallery-1.jpg);">
					...
					<div class="col-md-3 ftco-animate">
						<a href="views/images/gallery-2.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(views/images/gallery-2.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="views/images/gallery-3.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(views/images/gallery-3.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="views/images/gallery-4.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(views/images/gallery-4.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
