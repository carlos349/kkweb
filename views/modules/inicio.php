      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-10 ftco-animate text-center">
            ...
            <p>
            	<a href="https://kkprettynails.syswa.net/#/agendamientoCliente" style="font-size: 1em;" class="btn btn-primary p-3 px-5 py-4 mr-md-2">Agendar</a>
					...
					<div class="col-md-4 d-flex align-items-stretch">
						<div class="offer-deal text-center px-2 px-lg-5">
							...
							<div class="text mt-4">
								...
								<p><a href="https://kkprettynails.syswa.net/#/agendamientoCliente" class="btn btn-white px-4 py-3"> ¡Agenda tu servicio! </a></p>
							</div>
						</div>
					</div>
					<div class="col-md-4 d-flex align-items-stretch">
